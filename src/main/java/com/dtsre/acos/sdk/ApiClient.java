...
import com.dtsre.acos.sdk.auth.Authentication;
import com.dtsre.acos.sdk.auth.HttpBasicAuth;
import com.dtsre.acos.sdk.auth.HttpBearerAuth;
import com.dtsre.acos.sdk.auth.ApiKeyAuth;
...
public class ApiClient extends JavaTimeFormatter {
   ...
   * @return a {@link com.dtsre.acos.sdk.ApiClient} object.
   */
   ...
   * @param path 路径
   * @param method 方法
   * @param queryParams 参数集
   * @param body body
   * @param headerParams 请求头
   * @param cookieParams cookie
   * @param formParams 表单
   * @param accept 跨域
   * @param contentType 参数形式
   * @param authNames 权限
   * @param returnType 返回
   * @param isBodyNullable 是否空
   * @return 返回
   * @param <T> 参数
   * @throws ApiException 异常
   */
  ...
  /**
   * 修改权限
   * @param authNames 权限名称
   * @param queryParams 参数
   * @param headerParams 出请求头
   * @param cookieParams cookie
   * @param payload 参数
   * @param method 方法
   * @param uri url
